...
export default function TransferForm() {
  ...
  return (
    <section className="relative overflow-hidden bg-smoke py-9 md:py-16">
      <AmbientBackground variant="section" />
      <form className="container-shell relative z-10 grid gap-4 rounded-lg border border-zinc-200 bg-white p-4 shadow-sm md:grid-cols-2 md:p-5 lg:grid-cols-3" onSubmit={onSubmit}>
